...
import { DepGraph, DepGraphNode, modulesGraphOptions } from '../types'
...
export class NodeModulesGraph extends BaseDepGraph {
  ...
  async parse(): Promise<DepGraph> {
    ...
    if (this.savepath) {
      saveJsonFile(deduplicateRes, this.savepath)
    }
